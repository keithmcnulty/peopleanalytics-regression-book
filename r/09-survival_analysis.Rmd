# Survival Analysis for Modeling the Occurrence of Singular Events Over Time {#survival}
...
## Cox proportional hazard models for estimating the effect of input variables on a survival outcome {#coxphmodel}
...
```{r stratified, fig.align = "center", fig.cap = "Baseline retention curves for the two sentiment categories in the `job_retention` data set"}
