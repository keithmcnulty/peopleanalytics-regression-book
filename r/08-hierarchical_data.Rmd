...
Second, we can examine the fit statistics. Numerous statistics are reported[^hierarchical_data-2], but for larger samples such as this dataset, the following measures should be examined:
