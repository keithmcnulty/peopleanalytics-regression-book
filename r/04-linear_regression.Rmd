...
In this case, our input is a set of $p$ variables $x_1, x_2, ..., x_p$.  Extending the linear equation in Section \@ref(linear-single), we seek to develop an equation of the form:
...
`r if (knitr::is_latex_output()) '\\index{dummy variables!in linear regression}'`Many models will have categorical inputs rather than numerical inputs.  Categorical inputs usually take forms such as:
