...
`r if (knitr::is_latex_output()) '\\index{multinomial logistic regression!fit}'`As with the binomial case, a variety of Pseudo-$R^2$ methods are available to assess the fit of a multinomial logistic regression model, although some of our previous variants (particularly Tjur) are not defined on models with more than two outcome categories.
