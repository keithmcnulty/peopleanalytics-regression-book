...
5.  Use `read.csv()` to load the dataset of student test data found at https://raw.githubusercontent.com/keithmcnulty/eampa/master/data/ugtests.csv into an object named `ugtests`.  Calculate the dimensions of `ugtests` and view the first three rows only. 
