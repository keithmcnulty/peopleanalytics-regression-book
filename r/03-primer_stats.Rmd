...
```{r norm-dist, fig.cap = if (knitr::is_latex_output()) {"t-distribution of the mean sales difference between \\texttt{perf1} and \\texttt{perf4}, 95\\% confidence intervals (red lines) and a zero difference (blue line)"} else {"t-distribution of the mean sales difference between `perf1` and `perf4`, 95% confidence intervals (red lines) and a zero difference (blue line)"}, fig.align = "center", echo = FALSE, out.width = if (knitr::is_latex_output()) {"90%"}}
