...
Three common such hypothesis tests are testing for a difference in the means of two groups in a population, testing for a non-zero correlation between two variables, and testing for a difference in frequency distributions between different categories in a population.  We will go through an example of each of these.
