...
A hypothesis test for non-zero correlation coefficients is performed as follows:

```{julia, message = FALSE, warning = FALSE}
# test of non-zero correlation
CorrelationTest(salespeople.sales, salespeople.customer_rate)
```
