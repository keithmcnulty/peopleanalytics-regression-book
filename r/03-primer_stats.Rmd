...
We will go through an example of each of these.  During these examples we will go through the steps of manually calculating all the statistics needed to do the hypothesis testing, before we demonstrate the simple functions that perform the full test for you in R.  Users don't absolutely need to know all the details contained in this section, but a strong understanding of the underlying methods is encouraged.
