...
We can see from this pairplot that there is are clearly higher sales for those who are promoted versus those who are not sales.  We also see a moderate relationship between customer rating and sales, which is intuitive (if the customer doesn't like you, sales wouldn't likely be very high).
