...
You are an analyst for a large company consisting of numerous sales teams across the country.  Twice every year, this company promotes its salespeople.  Promotion is at the discretion of the head of each sales team, taking into consideration financial performance, customer satisfaction ratings, peer collaboration ratings and personal judgment.  

You are asked by the management of the company to conduct an analysis to determine how the three factors of financial performance, customer ratings and peer ratings influence the likelihood of a given salesperson being promoted.  You are provided with a dataset [here](https://raw.githubusercontent.com/keithmcnulty/eampa/master/data/salespeople.csv).
